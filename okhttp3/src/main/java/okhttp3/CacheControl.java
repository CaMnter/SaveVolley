...
/**
 * A Cache-Control header with cache directives from a server or client. These directives set
 * policy
...
public final class CacheControl {
    /**
     * Cache control request directives that require network validation of responses. Note that
     * such
     ...
     * for non-shared caches, As in Firefox and Chrome, this directive is not honored by this
     * cache.
     */
    ...
    /**
     * This field's name "only-if-cached" is misleading. It actually means "do not use the
     * network".
    ...
    public static final class Builder {
        ...
        /**
         * Only accept the response if it is in the cache. If the response isn't cached, a {@code
         * 504
