 ...
 * </ol>
 *
 * If hostname pinned directly and via wildcard pattern, both direct and wildcard pins will be
 * used.
 * For example: {@code *.example.com} pinned with {@code pin1} and {@code a.example.com} pinned
 * with
