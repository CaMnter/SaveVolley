...
public final class Util {
    ...
    public static String hostHeader(HttpUrl url, boolean includeDefaultPort) {
        ...
        return includeDefaultPort || url.port() != HttpUrl.defaultPort(url.scheme()) ? host + ":" +
                url.port() : host;
    }
    ...
    /**
     * Returns the index of the first character in {@code input} that contains a character in
     * {@code
