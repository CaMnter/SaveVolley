...
public final class StreamAllocation {
    ...
    public HttpStream newStream(int connectTimeout, int readTimeout, int writeTimeout, boolean connectionRetryEnabled, boolean doExtensiveHealthChecks)
        ...
        try {
            ...
            if (resultConnection.framedConnection != null) {
                ...
                resultStream = new Http1xStream(this, resultConnection.source,
    ...
    /**
     * Returns a connection to host a new stream. This prefers the existing connection if it
     * exists,
    ...
    /**
     * Use this allocation to hold {@code connection}. Each call to this must be paired with a call
     * to
