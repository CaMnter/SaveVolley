...
public final class Http1xStream implements HttpStream {
    ...
    @Override public void writeRequestHeaders(Request request) throws IOException {
        ...
        String requestLine = RequestLine.get(request,
                httpEngine.getConnection().route().proxy().type());
    ...
    public Response.Builder readResponse() throws IOException {
        ...
        try {
            ...
            IOException exception = new IOException(
                    "unexpected end of stream on " + streamAllocation);
     ...
     * timeout
     * to the default configuration. Use this to avoid unexpected sharing of timeouts between
     * pooled
     * connections.
     */
        ...
        @Override public void write(Buffer source, long byteCount) throws IOException {
            ...
            if (byteCount > bytesRemaining) {
                throw new ProtocolException(
                        "expected " + bytesRemaining + " bytes but received " + byteCount);
            }
    ...
    private abstract class AbstractSource implements Source {
        ...
        /**
         * Closes the cache entry and makes the socket available for reuse. This should be invoked
         * when
        ...
        private void readChunkSize() throws IOException {
            ...
            try {
                ...
                if (bytesRemainingInChunk < 0 ||
                        (!extensions.isEmpty() && !extensions.startsWith(";"))) {
                    throw new ProtocolException(
