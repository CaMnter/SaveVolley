...
public final class FramedStream {
    ...
    /**
     * The total number of bytes consumed by the application (with {@link FramedDataSource#read}),
     * but
    ...
    /**
     * The reason why this stream was abnormally closed. If there are multiple reasons to
     * abnormally
     ...
     * </ul>
     *
     * <p>Note that the input stream may continue to yield data even after a stream reports itself
     * as
     ...
     *
     * @throws IllegalStateException if this stream was initiated by the peer and a {@link #reply}
     * has
     * not yet been sent.
     */
    public Sink getSink() {
    ...
    private final class FramedDataSource implements Source {
        ...
        @Override public long read(Buffer sink, long byteCount) throws IOException {
            ...
            synchronized (FramedStream.this) {
                ...
                if (unacknowledgedBytesRead >= connection.okHttpSettings.getInitialWindowSize(
                        DEFAULT_INITIAL_WINDOW_SIZE) / 2) {
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean outFinished) throws IOException {
            ...
            synchronized (FramedStream.this) {
                writeTimeout.enter();
                try {
                    while (bytesLeftInWriteWindow <= 0 && !finished && !closed &&
                            errorCode == null) {
            ...
            writeTimeout.enter();
            try {
                connection.writeData(id, outFinished && toWrite == sendBuffer.size(), sendBuffer,
                        toWrite);
            } finally {
                writeTimeout.exitAndThrowIfTimedOut();
            }
    ...
    /**
     * The Okio timeout watchdog will call {@link #timedOut} if the timeout is reached. In that
     * case
