...
public final class Spdy3 implements Variant {
    ...
    static {
        try {
            DICTIONARY = ("\u0000\u0000\u0000\u0007options\u0000\u0000\u0000\u0004hea" +
                    ...
                    "sdchcharset=utf-8charset=iso-8859-1,utf-,*,enq=0.").getBytes(
                    Util.UTF_8.name());
    ...
    static final class Reader implements FrameReader {
        ...
        /**
         * Send the next frame to {@code handler}. Returns true unless there are no more frames on
         * the
         * stream.
         */
        ...
        private void readSettings(Handler handler, int flags, int length) throws IOException {
            ...
            if (length != 4 + 8 * numberOfEntries) {
                throw ioException("TYPE_SETTINGS length: %d != 4 + 8 * %d", length,
                        numberOfEntries);
            }
            ...
            boolean clearPrevious = (flags & Settings.FLAG_CLEAR_PREVIOUSLY_PERSISTED_SETTINGS) !=
                    0;
