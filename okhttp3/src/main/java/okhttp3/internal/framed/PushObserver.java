...
public interface PushObserver {
    ...
    /**
     * The response headers corresponding to a pushed request.  When {@code last} is true, there
     * are
    ...
    /**
     * A chunk of response data corresponding to a pushed request.  This data must either be read
     * or
     * skipped.
     *
     * @param streamId server-initiated stream ID: an even number.
