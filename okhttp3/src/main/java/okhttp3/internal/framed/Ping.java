...
public final class Ping {
    ...
    /**
     * Returns the round trip time for this ping in nanoseconds, waiting for the response to arrive
     * if
    ...
    /**
     * Returns the round trip time for this ping in nanoseconds, or -1 if the response was
     * canceled,
