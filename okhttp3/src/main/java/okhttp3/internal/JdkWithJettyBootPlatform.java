...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            return new JdkWithJettyBootPlatform(putMethod, getMethod, removeMethod,
    ...
    @Override public String getSelectedProtocol(SSLSocket socket) {
        try {
            JettyNegoProvider provider = (JettyNegoProvider) Proxy.getInvocationHandler(
                    getMethod.invoke(null, socket));
            if (!provider.unsupported && provider.selected == null) {
                Platform.get()
                        .log(INFO, "ALPN callback dropped: SPDY and HTTP/2 are disabled. " +
    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        @Override public Object invoke(Object proxy, Method method, Object[] args)
            ...
            if (methodName.equals("supports") && boolean.class == returnType) {
                ...
                return selected = protocols.get(
                        0); // On no intersection, try peer's first protocol.
