...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public synchronized void initialize() throws IOException {
        ...
        if (fileSystem.exists(journalFile)) {
            try {
                ...
                Platform.get()
                        .log(WARN, "DiskLruCache " + directory + " is corrupt: " +
    ...
    /**
     * Changes the maximum number of bytes the cache can store and queues a job to trim the
     * existing
     * store, if necessary.
     */
    ...
    /**
     * Drops the entry for {@code key} if it exists and can be removed. If the entry for {@code
     * key}
     * is currently being edited, that edit will complete normally but its value will not be
     * stored.
     *
    ...
    public final class Editor {
         ...
         * case
         * we delete the editor's created files and prevent new files from being created. Note that
         * once
         ...
         * underlying
         * output stream encounters errors when writing to the filesystem, this edit will be
         * aborted
