...
public final class ConnectionSpecSelector {
    ...
    public ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException {
        ...
        if (tlsConfiguration == null) {
            ...
            throw new UnknownServiceException(
                    "Unable to find acceptable protocols. isFallback=" + isFallback + ", modes=" +
                            connectionSpecs + ", supported protocols=" +
     ...
     * possible based on the supplied {@link SSLSocket}. It assumes that a future socket will have
     * the
