 ...
 * APIs.
 * Cleaning a chain returns a list of certificates where the first element is {@code chain[0]},
 * each
...
public abstract class CertificateChainCleaner {
    public static CertificateChainCleaner get(X509TrustManager trustManager) {
        try {
            ...
            Method checkServerTrusted = extensionsClass.getMethod("checkServerTrusted",
    ...
    static final class BasicCertificateChainCleaner extends CertificateChainCleaner {
         ...
         * constructed. This is unexpected unless the trust root index in this class has a
         * different
...
followIssuerChain:
     ...
     * 2012).
     * This is the best way to get a clean chain on Android because it uses the same code as the
     * TLS
     * handshake.
     */
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        @Override public List<Certificate> clean(List<Certificate> chain, String hostname)
            ...
            try {
                ...
                return (List<Certificate>) checkServerTrusted.invoke(x509TrustManagerExtensions,
                        certificates, "RSA", hostname);
            } catch (InvocationTargetException e) {
                SSLPeerUnverifiedException exception = new SSLPeerUnverifiedException(
                        e.getMessage());
