...
public final class ConnectionPool {
     ...
     * application.
     * The tuning parameters in this pool are subject to change in future OkHttp releases.
     * Currently
     * this pool holds up to 5 idle connections which will be evicted after 5 minutes of
     * inactivity.
     */
    ...
    RealConnection get(Address address, StreamAllocation streamAllocation) {
        ...
        for (RealConnection connection : connections) {
            if (connection.allocations.size() < connection.allocationLimit &&
                    address.equals(connection.route().address) && !connection.noNewStreams) {
    ...
    private int pruneAndGetAllocationCount(RealConnection connection, long now) {
        ...
        for (int i = 0; i < references.size(); ) {
            ...
            Platform.get()
                    .log(WARN, "A connection to " + connection.route().address().url() +
