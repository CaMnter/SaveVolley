...
public final class Cookie {
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        while (pos < limit) {
            ...
            String attributeValue = attributeEqualsSign < attributePairEnd ? trimSubstring(
                    setCookie, attributeEqualsSign + 1, attributePairEnd) : "";
    ...
    /**
     * Returns the index of the next date character in {@code input}, or if {@code invert} the
     * index
    ...
    /**
     * Returns the positive value if {@code attributeValue} is positive, or {@link Long#MIN_VALUE}
     * if
    ...
    /**
     * Returns a domain string like {@code example.com} for an input domain like {@code
     * EXAMPLE.COM}
     * or {@code .example.com}.
     */
    ...
    /**
     * Returns true if this cookie's domain should be interpreted as a single host name, or false
     * if
     ...
     * example.com} and all subdomains including {@code api.example.com}, {@code www.example.com},
     * and
    ...
    /**
     * Returns the cookie's domain. If {@link #hostOnly()} returns true this is the only domain
     * that
     ...
     * this path's segments. For example, if this path is {@code /foo} this cookie matches requests
     * to
    ...
    public boolean matches(HttpUrl url) {
        boolean domainMatch = hostOnly ? url.host().equals(domain) : domainMatch(url, domain);
    ...
    @Override public boolean equals(Object other) {
        ...
        return that.name.equals(name) && that.value.equals(value) && that.domain.equals(domain) &&
                ...
                that.httpOnly == httpOnly && that.persistent == persistent &&
