...
/**
 * The header fields of a single HTTP message. Values are uninterpreted strings; use {@code
 * Request}
 * and {@code Response} for interpreted headers. This class maintains the order of the header
 * fields
...
public final class Headers {
    ...
    private Headers(Builder builder) {
        this.namesAndValues = builder.namesAndValues.toArray(
                new String[builder.namesAndValues.size()]);
    }
    ...
    public static final class Builder {
        ...
        /**
         * Add a field with the specified value without any validation. Only appropriate for
         * headers
        ...
        private void checkNameAndValue(String name, String value) {
            ...
            for (int i = 0, length = name.length(); i < length; i++) {
                ...
                if (c <= '\u001f' || c >= '\u007f') {
                    throw new IllegalArgumentException(
                            Util.format("Unexpected char %#04x at %d in header name: %s", (int) c,
                                    i, name));
                }
            }
            ...
            for (int i = 0, length = value.length(); i < length; i++) {
                ...
                if (c <= '\u001f' || c >= '\u007f') {
                    throw new IllegalArgumentException(
                            Util.format("Unexpected char %#04x at %d in %s value: %s", (int) c, i,
                                    name, value));
                }
            }
        }
