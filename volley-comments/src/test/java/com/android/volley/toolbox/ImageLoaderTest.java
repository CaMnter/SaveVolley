...
@RunWith(RobolectricTestRunner.class) public class ImageLoaderTest {
    ...
    @Test public void getWithCacheMiss() throws Exception {
        when(mImageCache.getBitmap(anyString())).thenReturn(null);
        ImageLoader.ImageListener listener = mock(ImageLoader.ImageListener.class);
    ...
    @Test public void publicMethods() throws Exception {
        ...
        assertNotNull(ImageLoader.class.getMethod("getImageListener", ImageView.class, int.class,
                int.class));
        ...
        assertNotNull(
                ImageLoader.class.getMethod("get", String.class, ImageLoader.ImageListener.class,
                        int.class, int.class, ImageView.ScaleType.class));
