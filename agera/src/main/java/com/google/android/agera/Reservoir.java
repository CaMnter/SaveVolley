 ...
 * but <i>not when the last value is dequeued so the reservoir becomes empty</i>. In other words,
 * an
 ...
 * it is already non-empty, the updatable will receive an out-of-band update immediately (subject
 * to
 ...
 * as their shared event source and data source can be a simple way to achieve parallelism with
 * load
 * balancing.
 */
