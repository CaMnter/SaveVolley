...
public final class Response implements Closeable {
    ...
    /**
     * Peeks up to {@code byteCount} bytes from the response body and returns them as a new
     * response
     * body. If fewer than {@code byteCount} bytes are in the response body, the full response body
     * is
    ...
    @Override public String toString() {
        return "Response{protocol=" + protocol + ", code=" + code + ", message=" + message +
                ", url=" + request.url() + '}';
    }
