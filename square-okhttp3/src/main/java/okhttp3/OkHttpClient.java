...
public class OkHttpClient implements Cloneable, Call.Factory {
    private static final List<Protocol> DEFAULT_PROTOCOLS = Util.immutableList(Protocol.HTTP_2,
            Protocol.SPDY_3, Protocol.HTTP_1_1);

    private static final List<ConnectionSpec> DEFAULT_CONNECTION_SPECS;


    static {
        List<ConnectionSpec> connSpecs = new ArrayList<>(
    ...
    /**
     * Returns an immutable list of interceptors that observe a single network request and
     * response.
    ...
    public static final class Builder {
         ...
         * (which
         * it is by default). To disable proxy use completely, call {@code
         ...
         * be used.
         *
         * @deprecated {@code SSLSocketFactory} does not expose its {@link X509TrustManager}, which
         * is
        ...
        /**
         * Sets the socket factory and trust manager used to secure HTTPS connections. If unset,
         * the
         ...
         * compatibility problems, such as web servers that behave incorrectly when SPDY is
         * enabled.
         *
         ...
         * href="http://tools.ietf.org/html/draft-ietf-tls-applayerprotoneg">ALPN</a> will be used
         * to
        ...
        public Builder protocols(List<Protocol> protocols) {
            ...
            if (!protocols.contains(Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException(
                        "protocols doesn't contain http/1.1: " + protocols);
            }
            if (protocols.contains(Protocol.HTTP_1_0)) {
                throw new IllegalArgumentException(
                        "protocols must not contain http/1.0: " + protocols);
            }
