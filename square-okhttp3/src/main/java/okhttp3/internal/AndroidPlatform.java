...
class AndroidPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            OptionalMethod<Socket> setUseSessionTickets = new OptionalMethod<>(null,
                    "setUseSessionTickets", boolean.class);
            OptionalMethod<Socket> setHostname = new OptionalMethod<>(null, "setHostname",
                    String.class);
    ...
    @Override public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        X509TrustManager x509TrustManager = readFieldOrNull(context, X509TrustManager.class,
                "x509TrustManager");
    ...
    @Override public boolean isCleartextTrafficPermitted() {
        try {
            ...
            Method isCleartextTrafficPermittedMethod = networkPolicyClass.getMethod(
                    "isCleartextTrafficPermitted");
            boolean cleartextPermitted = (boolean) isCleartextTrafficPermittedMethod.invoke(
