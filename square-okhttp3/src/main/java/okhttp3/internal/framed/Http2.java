...
public final class Http2 implements Variant {
    ...
    private static final ByteString CONNECTION_PREFACE = ByteString.encodeUtf8(
            "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    private static int readMedium(BufferedSource source) throws IOException {
        return (source.readByte() & 0xff) << 16 | (source.readByte() & 0xff) << 8 |
    ...
    /**
     * Creates a frame reader with max header table size of 4096 and data frame compression
     * disabled.
     */
    ...
    static final class Reader implements FrameReader {
       ...
       */
        ...
        private void readGoAway(Handler handler, int length, byte flags, int streamId)
            ...
            if (opaqueDataLength >
                    0) { // Must read debug data in order to not corrupt the connection.
    ...
    static final class FrameLogger {
        ...
        static {
            ...
            FLAGS[FLAG_END_HEADERS | FLAG_PRIORITY]
                    = "END_HEADERS|PRIORITY"; // Only valid on HEADERS.
        ...
        /**
         * Looks up valid string representing flags from the table. Invalid combinations are
         * represented
         * in binary.
         */
        // Visible for testing.
