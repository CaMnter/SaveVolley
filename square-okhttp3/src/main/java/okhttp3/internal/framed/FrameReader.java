...
public interface FrameReader extends Closeable {
    ...
    interface Handler {
        ...
        /**
         * Read a connection-level ping from the peer.  {@code ack} indicates this is a reply.
         * Payload
         * parameters are different between SPDY/3 and HTTP/2.
         *
         * <p>In SPDY/3, only the first {@code payload1} parameter is set.  If the reader is a
         * client,
         ...
         * alternate
         * service is the origin of the stream. When zero, the origin is specified in the {@code
         * origin}
         * parameter.
         * @param origin when present, the <a href="http://tools.ietf.org/html/rfc6454">origin</a>
         * is
         * typically represented as a combination of scheme, host and port. When empty, the origin
         * is
