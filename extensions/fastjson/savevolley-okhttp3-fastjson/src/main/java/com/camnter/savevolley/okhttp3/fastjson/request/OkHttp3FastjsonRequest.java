...
/**
 * Description：OkHttp3FastjsonRequest
 * Created by：CaMnter
 * Time：2016-06-27 14:59
 */

public abstract class OkHttp3FastjsonRequest<T> extends Request<T>
    ...
    public OkHttp3FastjsonRequest(int method,
                                  @NonNull String url,
                                  @NonNull Class<T> clazz) {
